  <?php if (!defined('__TYPECHO_ROOT_DIR__')) exit; ?>
     ...
     <div id="sidebar">
      <section id="tabs-4" class="widget widget_tabs clear">
       <div class="nav-tabs-alt no-js-hide">
        <ul class="nav nav-tabs nav-justified" role="tablist">
         <li class="active" role="presentation"> <a href="#widget-tabs-4-hots" role="tab" aria-controls="widget-tabs-4-hots" aria-expanded="true" data-toggle="tab"> <i class="iconfont icon-fire text-md text-muted wrapper-sm" aria-hidden="true"></i> <span class="sr-only"><?php _me("热门文章") ?></span> </a></li>
         <li role="presentation"> <a href="#widget-tabs-4-comments" role="tab" aria-controls="widget-tabs-4-comments" aria-expanded="false" data-toggle="tab"> <i class="iconfont icon-comments text-md text-muted wrapper-sm" aria-hidden="true"></i> <span class="sr-only"><?php _me("最新评论") ?></span> </a></li>
         <li role="presentation"> <a href="#widget-tabs-4-random" role="tab" aria-controls="widget-tabs-4-random" aria-expanded="false" data-toggle="tab"> <i class="iconfont icon-random text-md text-muted wrapper-sm" aria-hidden="true"></i> <span class="sr-only"><?php _me("随机文章") ?></span> </a></li>
        </ul>
       </div>
       ...
       <!--热门文章-->
        ...
        ?>
              ...
              <a href="<?php $comments->permalink(); ?>" class="text-muted">
                  <i class="iconfont icon-commento pull-right m-t-sm text-sm" title="<?php _me("详情") ?>" aria-hidden="true" data-toggle="tooltip" data-placement="auto left"></i>
      ...
      <section id="categories-2" class="widget widget_categories wrapper-md clear">
       <h3 class="widget-title m-t-none text-md"><?php _me("分类") ?></h3>
       <ul class="list-group">
