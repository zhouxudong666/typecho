        ...
        <form method="post" class="navbar-form navbar-form-sm navbar-left shift" role="search">
          <div class="form-group">
            <div class="input-group">
              <input id="keyword" type="search" name="s" class="form-control input-sm bg-light no-border rounded padder" placeholder="<?php _me("输入关键词搜索…") ?>" onkeypress="getKey()"/>
            ...
            <ul class="dropdown-menu animated fadeInRight w">
              <li class="wrapper b-b m-b-sm bg-light m-t-n-xs">
                ...
                <?php elseif($time>=12 && $time<=17): ?>
                  <p><?php _me("中午好，") ?><?php $this->user->screenName(); ?>.</p>
                <?php else : ?>
              ...
              <!--评论RSS订阅-->
              <li>
                <a data-no-instant target="_blank" href="<?php $this->options->commentsFeedUrl(); ?>"><i style="position: relative;width: 30px;margin: -11px -10px;margin-right: 0px;overflow: hidden;line-height: 30px;text-align: center;" class="iconfont icon-rss1"></i><span><?php _me("评论RSS") ?></span></a>
              </li>
              <!--后台管理(登录时候才会显示)-->
              <?php if($this->user->hasLogin()): ?>
              <li>
                <a data-no-instant target="_blank" href="<?php $this->options->adminUrl(); ?>"><i style="position: relative;width: 30px;margin: -11px -10px;margin-right: 0px;overflow: hidden;line-height: 30px;text-align: center;" class="iconfont icon-cogs"></i><span><?php _me("后台管理") ?></span></a>
              </li>
              <?php else: ?>
              <?php endif; ?>
              ...
              <li class="divider"></li>
              <li>
                <a data-no-instant href="<?php $this->options->logoutUrl(); ?>"><?php _me("退出") ?></a>
              </li>
            </ul>
            <!-- / dropdown(已经登录) -->
          <?php else: ?>
